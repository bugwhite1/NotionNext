...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '九渊', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '助力你拥有构建有序的工作流、清明的思维与高效的人生。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.entroflow.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '熵减法则,构建第二大脑,高效指南', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是九渊, Hi，熵减高效指南将助您从混乱走向心流,Hi，欢迎来到我的博客🎉',
